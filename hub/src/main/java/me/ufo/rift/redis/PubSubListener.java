...
public final class PubSubListener implements RedisPubSubListener<String, String> {
    ...
    public void message(final String listenerChannel, final String rawMessage) {
        ...
        if (messageParts.length == 3) {
            ...
            final String channel = Preconditions.checkNotNull(messageParts[1], "Channel null");
            final String message = Preconditions.checkNotNull(messageParts[2], "Message null");
            ...
            final RiftboundMessageEvent event = new RiftboundMessageEvent(source, channel, message);
